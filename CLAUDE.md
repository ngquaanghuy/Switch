...
| `--encrypt <type> <file> --key <hex> [--iv/--nonce <hex>] [-o <out>]` | Working | 11 types: aes-128, aes-192, aes-256, chacha20, xchacha20, aes-{128,192,256}-gcm, aes-{128,192,256}-ccm. IV/nonce auto-generated if omitted. |
| `--encode-list` | Working | |
