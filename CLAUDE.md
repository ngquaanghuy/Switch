...
| `--encrypt <type> <file> --key <hex> [--iv/--nonce <hex>] [-o <out>]` | Working | 6 types: aes-128, aes-192, aes-256, chacha20, xchacha20, aes-256-gcm. IV/nonce auto-generated if omitted. |
| `--encode-list` | Working | |
